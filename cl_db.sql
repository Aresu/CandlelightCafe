...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2023 at 05:31 PM
...
('3d560b655999', 'Arabella', '09489892436', 'arabella@mail.com', 'adcd7048512e64b48da55b027577886ee5a36350', '2023-11-22 01:39:34.018843'),
('cf8ef6f272d5', 'Mathew', '09683099200', 'mathew@mail.com', 'adcd7048512e64b48da55b027577886ee5a36350', '2023-11-22 01:37:49.063867');
...
INSERT INTO `orders` (`order_id`, `order_code`, `customer_id`, `customer_name`, `prod_id`, `prod_name`, `prod_price`, `prod_qty`, `order_status`, `created_at`) VALUES
('1b2e9bfc5d', 'XVAE-5480', 'cf8ef6f272d5', 'Mathew', 'e769e274a3', 'Frappuccino', '3', '1', '', '2023-11-22 18:13:44.822586');
...
INSERT INTO `pass_resets` (`reset_id`, `reset_code`, `reset_token`, `reset_email`, `reset_status`, `created_at`) VALUES
...
INSERT INTO `payments` (`pay_id`, `pay_code`, `order_code`, `customer_id`, `pay_amt`, `pay_method`, `created_at`) VALUES
...
(1, 'Cashier', 'YDWR-2851', 'cashier@mail.com', '3827f2b2fbf2857befef22fc13505254f665e3bc', '2023-11-22 01:16:27.193331');
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `CustomerOrder` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ProductOrder` FOREIGN KEY (`prod_id`) REFERENCES `products` (`prod_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
