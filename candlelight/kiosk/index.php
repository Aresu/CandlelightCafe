...
if (isset($_POST['login'])) {
    ...
    $stmt = $mysqli->prepare("SELECT customer_email, customer_password, customer_id  FROM  customers WHERE (customer_email =? AND customer_password =?)"); //sql to log in user
                ...
                <div class="header-body text-center mb-5">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-md-6">
                            <h1 class="text-white">Candlelight Cafe | Kiosk</h1>
                        </div>
                    </div>
                </div>
            </div>
