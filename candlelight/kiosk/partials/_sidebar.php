...
$ret = "SELECT * FROM  customers  WHERE customer_id = '$customer_id'";
...
?>
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <!-- Brand -->
      <a class="navbar-brand pt-3" href="dashboard.php">
        <img src="../admin/assets/img/brand/candle.png" class="navbar-brand-img" alt="...">
      </a>
      <!-- User -->
          ...
          <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="media align-items-center">
              <span class="avatar avatar-sm rounded-circle">
                <img alt='Image placeholder' src='../admin/assets/img/brand/candle.png'>
              </span>
            </div>
          </a>
          ...
          <div class="row">
            <div class="col-6 collapse-brand">
              <a href="dashboard.php">
                <img src="../admin/assets/img/brand/candle.png">
              </a>
            </div>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="orders.php">
              <i class="ni ni-cart text-dark"></i>Make Order
            </a>
          </li>
          <li class="nav-item">
