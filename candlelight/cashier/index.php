...
if (isset($_POST['login'])) {
  ...
  $stmt = $mysqli->prepare("SELECT staff_email, staff_password, staff_id  FROM   staff WHERE (staff_email =? AND staff_password =?)"); //sql to log in user
        ...
        <div class="header-body text-center mb-5">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              <h1 class="text-white">Candlelight Cafe | Cashier</h1>
            </div>
          </div>
        </div>
      </div>
