...
if (isset($_POST['pay'])) {
  ...
  if (empty($_POST["pay_code"]) || empty($_POST["pay_amt"]) || empty($_POST['pay_method'])) {
    ...
    $postQuery = "INSERT INTO payments (pay_id, pay_code, order_code, customer_id, pay_amt, pay_method) VALUES(?,?,?,?,?,?)";
    $upQry = "UPDATE orders SET order_status =? WHERE order_code =?";
...
<body>
  ...
  <div class="main-content">
    ...
    $order_code = $_GET['order_code'];
    $ret = "SELECT * FROM  orders WHERE order_code ='$order_code' ";
