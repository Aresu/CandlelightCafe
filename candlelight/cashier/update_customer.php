...
if (isset($_POST['updateCustomer'])) {
  ...
  if (empty($_POST["customer_name"]) || empty($_POST['customer_email']) || empty($_POST['customer_password'])) {
    ...
    $postQuery = "UPDATE customers SET customer_name =?, customer_email =?, customer_password =? WHERE  customer_id =?";
    $postStmt = $mysqli->prepare($postQuery);
    //bind paramaters
    $rc = $postStmt->bind_param('sssss', $customer_name, $customer_email, $customer_password, $update);
    $postStmt->execute();
...
<body>
  ...
  <div class="main-content">
    ...
    $update = $_GET['update'];
    $ret = "SELECT * FROM  customers WHERE customer_id = '$update' ";
